...
func (l ULog) LogWithLevel(level LogLevel, v ...interface{}) { LogWithLevel(logLevel, v...) }
func (l ULog) LogWithLevelf(level LogLevel, fmtString string, v ...interface{}) {
	LogWithLevelf(logLevel, fmtString, v...)
}
